...
SUSPICIOUS_CHAINS = [
    ...
    ("chrome.exe",  "powershell.exe",  "Chrome-downloaded file spawning PowerShell", "T1566.002", "CRITICAL"),
    ("firefox.exe", "powershell.exe",  "Firefox-downloaded file spawning PowerShell", "T1566.002", "CRITICAL"),
    ("chrome",      "bash",            "Chrome-downloaded file spawning shell (Linux)", "T1566.002", "HIGH"),
    ("firefox",     "bash",            "Firefox-downloaded file spawning shell (Linux)", "T1566.002", "HIGH"),
    ("thunderbird", "bash",            "Thunderbird attachment spawning shell", "T1566.001", "CRITICAL"),
    ("thunderbird", "powershell.exe",  "Thunderbird attachment spawning PowerShell", "T1566.001", "CRITICAL"),
